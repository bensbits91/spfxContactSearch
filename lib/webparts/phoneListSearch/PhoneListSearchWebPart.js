    ...
    FilterPanel.prototype.render = function () {
        return (React.createElement(Panel, { key: this.state.clearFilters ? 'ReRender' : 'noReRender', isOpen: this.state.showPanel, closeButtonAriaLabel: 'Close', isLightDismiss: true, headerText: 'Filter Contacts', onDismiss: this._hidePanel, onRenderFooterContent: this._onRenderFooterContent, isHiddenOnDismiss: true, isFooterAtBottom: true, type: PanelType.custom, customWidth: '420px' },
            React.createElement(Dropdown, { placeholder: this.state.prefilter_key_department != null
                    ...
                    : 'Select departments...', label: 'Department', multiSelect: true, options: this.props.departmentOptions, styles: { dropdown: { width: 300 } }, disabled: this.state.prefilter_key_department != null
                    && this.state.prefilter_key_department != undefined
                    && this.state.prefilter_key_department != 'NoFilter', onChange: this._onFilterChangeDepartment }),
            React.createElement(Dropdown, { placeholder: this.state.prefilter_key_division != null
                    ...
                    : 'Select divisions...', label: 'Division', multiSelect: true, options: this.props.divisionOptions, styles: { dropdown: { width: 300 } }, disabled: this.state.prefilter_key_division != null &&
                    this.state.prefilter_key_division != undefined
                    && this.state.prefilter_key_division != 'NoFilter', onChange: this._onFilterChangeDivision }),
            React.createElement(Dropdown, { placeholder: 'Select organizations...', label: 'Organization', multiSelect: true, options: availOrganizationsObject, styles: { dropdown: { width: 300 } }, onChange: this._onFilterChangeOrganization })));
    };
    return FilterPanel;
}(React.Component));
export { FilterPanel };
